 ...
 * @param {String} [fieldPrefix] - If this is a subquery, the path to the parent field
 */
class Query {

	constructor(queryData, queryFactory, fieldPrefix) {
		...
		for (let key in query) {
			...
			if (key[0] === '$') {
				...
				if (queryOperator) {
					...
					handlers.queryOperator.call(queryOperator, exprValue, fieldWithPrefix, this);
