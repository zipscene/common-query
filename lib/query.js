 ...
 * @param {String} [options.varSubstitutions] - If this query contains $var statements, this is a map
...
class Query {
	...
	constructor(queryData, queryFactory, options = {}) {
		...
		if (options.varSubstitutions) this._substituteVars(options.varSubstitutions);
		this.validate();
	}
