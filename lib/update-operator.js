...
class UpdateOperator {
	 ...
	 * Reference parent[parentKey] to set the value if necessary.
	 ...
	 * @param {Update} update
	 * @param {Object} parent - The parent object containing this update operator
	 * @param {String} parentKey - The key on the parent object
	 */
	normalize(operatorValue, operator, options, update, parent, parentKey) {
